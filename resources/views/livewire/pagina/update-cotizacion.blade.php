<tr>
    ...
    <td class="px-1 py-1 whitespace-nowrap">
        <div class="flex items-center space-x-2">
            <div class="w-14">
                <img class="w-full rounded-xl" src="{{Storage::url($detalleCotizacion->producto->image)}}" alt="">
            </div>
            <div class="text-xs text-gray-900 flex flex-col">
                <span class="font-bold">{{ $detalleCotizacion->producto->nombre }}</span>
                <div class="flex items-center space-x-2">
                    <span>Marca:</span>
