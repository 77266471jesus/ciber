<div>
    <h1 class="text-2xl font-bold py-4 pl-4 text-green-500">COTIZACIÓN DE PRODUCTOS</h1>
    ...
    @endif
    @include('livewire.admin.cotizacion.modal-productos-cotizacion')
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y-2 divide-gray-200">
                @foreach ($detalleCotizacions as $detalleCotizacion)
                    @livewire('admin.cotizacion.update-detalle-cotizacion', ['detalleCotizacion' => $detalleCotizacion], key($detalleCotizacion->id))
                @endforeach
            </tbody>
        </table>
    </x-table>
