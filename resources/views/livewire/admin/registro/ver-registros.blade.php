<div>
    ...
    <div
        ...
        @endif
        @can('admin.registro.usuarios.excel')
            <div class="w-full md:w-2/6">
                <a href="{{ route('admin.registros.excel', [$user_id, $fecha]) }}"
