<div>
    ...
    <div
        ...
        @endif
        @can('admin.historial.compras.excel')
            <div class="w-full md:w-2/6">
                <a href="{{ route('admin.historialcompra.excel', [$producto_id, $fecha]) }}"
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            ...
                            wire:click="order('ingresos.fecha')">
                            <span>FECHA</span>
                            @if ($sort == 'ingresos.fecha')
                                @if ($direction == 'asc')
                        ...
                        <th scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                            wire:click="order('detalle_ingresos.cantidad')">
                            <span>CANTIDAD</span>
                            @if ($sort == 'detalle_ingresos.cantidad')
                                @if ($direction == 'asc')
                                    <i class='pl-2 bx bx-sort-z-a'></i>
                                @else
                                    <i class='pl-2 bx bx-sort-a-z'></i>
                        ...
                        <th scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                            wire:click="order('detalle_ingresos.precio_compra')">
                            <span>PRECIO COMPRA</span>
                            @if ($sort == 'detalle_ingresos.precio_compra')
                                @if ($direction == 'asc')
                                    <i class='pl-2 bx bx-sort-z-a'></i>
                                @else
                                    <i class='pl-2 bx bx-sort-a-z'></i>
                        ...
                        <th scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                            wire:click="order('detalle_ingresos.precio_venta')">
                            <span>PRECIO VENTA</span>
                            @if ($sort == 'detalle_ingresos.precio_venta')
                                @if ($direction == 'asc')
                                    <i class='pl-2 bx bx-sort-z-a'></i>
                                @else
                                    <i class='pl-2 bx bx-sort-a-z'></i>
                        ...
                        <th scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                            wire:click="order('detalle_ingresos.subtotal')">
                            <span>TOTAL</span>
                            @if ($sort == 'detalle_ingresos.subtotal')
                                @if ($direction == 'asc')
                                    <i class='pl-2 bx bx-sort-z-a'></i>
                                @else
                                    <i class='pl-2 bx bx-sort-a-z'></i>
                        ...
                        <th scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                            wire:click="order('ingresos.tipo_comprobante')">
                            <span>COMPRA</span>
                            @if ($sort == 'ingresos.tipo_comprobante')
                                @if ($direction == 'asc')
                                    <i class='pl-2 bx bx-sort-z-a'></i>
                                @else
                                    <i class='pl-2 bx bx-sort-a-z'></i>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($detalleIngresos as $detalleIngreso)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ $detalleIngreso->precio_compra }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ $detalleIngreso->precio_venta }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ $detalleIngreso->nombre }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm ">
                                    {{ $detalleIngreso->tipo_comprobante }}
                                </div>
                                <div class="text-sm ">
                                    {{ $detalleIngreso->comprobante }}
                                </div>
                            </td>
                        </tr>
                    @endforeach
