                    ...
                    <div class="w-full px-4">
                        <div class="w-full flex flex-col md:flex-row">
                            <div class="w-full md:w-3/5 px-2">
                                ...
                                <input type="text" value="{{ $show_venta->cliente->nombre }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                            <div class="w-full md:w-2/5 px-2 md:pl-12 ">
                                <x-jet-label value="Fecha" />
                                <input type="text" value="{{ $show_venta->fecha }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                        </div>
                        <div class="w-full flex flex-col md:flex-row">
                            <div class="w-full md:w-3/5 px-2">
                                ...
                                <input type="text" value="{{ $show_venta->tipo_comprobante }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                            <div class="w-full md:w-2/5 px-2 md:pl-12 ">
                                <x-jet-label value="Numero de Comprobante" />
                                <input type="text" value="{{ $show_venta->comprobante }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                        </div>
                        <div class="w-full flex flex-col md:flex-row">
                            <div class="w-full md:w-3/5 px-2">
                                ...
                                <input type="text" value="{{ $show_venta->cliente->tipo_documento }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                            <div class="w-full md:w-2/5 px-2 md:pl-12 ">
                                <x-jet-label value="N° Documento Proveedor" />
                                <input type="text" value="{{ $show_venta->cliente->documento }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 space-x-0 md:space-x-2">
                            <div class="px-2 md:px-0">
                                ...
                                <input type="text" value="{{ $show_venta->cliente->telefono }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                            <div class="px-2 md:px-0">
                                {{-- email --}}
                                <x-jet-label value="Correo/Email" />
                                <input type="text" value="{{ $show_venta->cliente->email }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                            <div class="px-2 md:px-0">
                                {{-- direccion --}}
                                <x-jet-label value="Direccion" />
                                <input type="text" value="{{ $show_venta->cliente->direccion }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 space-x-0 md:space-x-2 pb-4">
                            <div class="px-2 md:px-0">
                                ...
                                <input type="text" value="{{ $show_venta->impuesto }}" disabled
                                    class="w-full rounded-md border-2 border-gray-300">
                            </div>
                        </div>
                        <x-table>
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y-2 divide-gray-200">
                                    @foreach ($show_venta->detalleVentas as $detalle)
                                        <tr>                                            
                        ...
                        <div class="w-full px-6 pt-2 pb-4">
                            <div class="font-semibold flex justify-end py-2 px-2 bg-green-400 pr-4">
                                ...
                                <span>{{ $show_venta->total_venta }}.</span>
                            </div>
                        </div>
                    </div>
                @endif
