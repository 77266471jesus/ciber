<tr>
    ...
    <td>
        <div class="text-sm text-gray-900">
            <input type="number" class="w-28 h-8 border-2 border-gray-300 bg-gray-100" wire:model="venta" disabled>
            <x-jet-input-error for="venta" />
        </div>
    </td>
    <td>
        <div class="text-sm text-gray-900">
            <input type="number" class="w-24 h-8 border-2 border-gray-300" wire:model="descuento">
