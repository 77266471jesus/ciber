...
<body>
    <div class="header">
        ...
        <div class="datos_comprobante">
            ...
            <div class="datos_comprobante_numeros">
                <h2>0129660357</h2>
                <h2>00{{ $cotizacion->comprobante}}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="cliente">
        ...
        <div class="datos_cliente_datos">
            <h2>{{ $cotizacion->fecha }}</h2>
            <h2>{{ $cotizacion->cliente->nombre }}</h2>
            <h2>{{ $cotizacion->cliente->documento  }}</h2>
            <h2>{{ $cotizacion->cliente->direccion }}</h2>
        </div>       
    </div>
    <div class="tabla">
        <table border="2" class="tabla_detalle">
            ...
            <tbody class="tabla_body">
                ...
                <tr>
                    ...
                    <th class="title">SUBTOTAL:</th>
                    <td class="parrafo">{{ $cotizacion->total_cotizacion }}</td>
                </tr>
                <tr>                  
                    <th class="title">TOTAL:</th>
                    <td class="parrafo">{{ $cotizacion->total}}</td>
                </tr>
            </tbody>
        </table>
    </div>
    <div class="comprobante_footer">
        <p>Esta proforma tiene validez de 30 dias desde la fecha de: <span>{{ $cotizacion->fecha}}</span></p>         
    </div>
    <div class="comprobante_footer">
