...
class ClienteUsuario extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function edit(User $user)
    {
        ...
        $this->identificador = rand();
        $this->open_edit = true;
        $this->cliente = Cliente::where('email', $this->user->email)->first();
    }
    public function update()
    {
        ...
        // cliente edit 
        $this->cliente->nombre = $this->user->name;
        $this->cliente->tipo_documento = $this->user->tipo_documento;
        $this->cliente->documento = $this->user->ci;
        $this->cliente->direccion = $this->user->direccion;
        $this->cliente->telefono = $this->user->telefono;
    ...
    public function render()
    {
        ...
        $users = User::whereIn('cargo', ['Usuario'])
        ...
        return view('livewire.admin.usuarios.cliente-usuario', compact('users', 'roles'));
    }
